    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <input
          ...
          className="mt-2.5 block w-full rounded-md border-gray-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
      ...
      {/* Pre-Selected Tempo */}
      <div>
        <label htmlFor="preSelectedTempo" className="block text-sm font-semibold leading-6 text-gray-900">
          Pre-Selected Tempo
        </label>
        <input
          type="text"
...
TimingInfoForm.propTypes = {
  formData: PropTypes.shape({
    ...
    barNumbers: PropTypes.arrayOf(PropTypes.number),
  }).isRequired,
